...
public final class WallDecoration {
	...
	public static PacketBufferNode method4664(int var0, String var1, Language var2, int var3) {
		PacketBufferNode var4 = class120.getPacketBufferNode(ClientPacket._MESSAGE_PUBLIC, Client.packetWriter.isaacCipher); // L: 17
	...
	static void setWindowedMode(int var0) {
		...
		if (Client.gameState >= 25) { // L: 4270
			PacketBufferNode var1 = class120.getPacketBufferNode(ClientPacket._WINDOW_STATUS, Client.packetWriter.isaacCipher); // L: 4272
