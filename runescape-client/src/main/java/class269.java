		...
		if (!var0) { // L: 5552
			...
			if (!var0) { // L: 5570
				...
				if (IgnoreList.client.hasFrame()) { // L: 5695
					var17 = class120.getPacketBufferNode(ClientPacket._DETECT_MODIFIED_CLIENT, Client.packetWriter.isaacCipher); // L: 5697
				...
				var17 = class120.getPacketBufferNode(ClientPacket._MAP_BUILD_COMPLETE, Client.packetWriter.isaacCipher); // L: 5717
