		...
		if (var5 != null) { // L: 9270
			...
			if (var11) { // L: 9281
				...
				if (var7) { // L: 9288
					...
					if (var0 == 1) { // L: 9291
						var10 = class120.getPacketBufferNode(ClientPacket._IF_BUTTON1, Client.packetWriter.isaacCipher); // L: 9293
					...
					if (var0 == 2) { // L: 9299
						var10 = class120.getPacketBufferNode(ClientPacket._IF_BUTTON2, Client.packetWriter.isaacCipher); // L: 9301
					...
					if (var0 == 3) { // L: 9307
						var10 = class120.getPacketBufferNode(ClientPacket._IF_BUTTON3, Client.packetWriter.isaacCipher); // L: 9309
					...
					if (var0 == 4) { // L: 9315
						var10 = class120.getPacketBufferNode(ClientPacket._IF_BUTTON4, Client.packetWriter.isaacCipher); // L: 9317
					...
					if (var0 == 5) { // L: 9323
						var10 = class120.getPacketBufferNode(ClientPacket._IF_BUTTON5, Client.packetWriter.isaacCipher); // L: 9325
					...
					if (var0 == 6) { // L: 9331
						var10 = class120.getPacketBufferNode(ClientPacket._IF_BUTTON6, Client.packetWriter.isaacCipher); // L: 9333
					...
					if (var0 == 7) { // L: 9339
						var10 = class120.getPacketBufferNode(ClientPacket._IF_BUTTON7, Client.packetWriter.isaacCipher); // L: 9341
					...
					if (var0 == 8) { // L: 9347
						var10 = class120.getPacketBufferNode(ClientPacket._IF_BUTTON8, Client.packetWriter.isaacCipher); // L: 9349
					...
					if (var0 == 9) { // L: 9355
						var10 = class120.getPacketBufferNode(ClientPacket._IF_BUTTON9, Client.packetWriter.isaacCipher); // L: 9357
					...
					if (var0 == 10) { // L: 9363
						var10 = class120.getPacketBufferNode(ClientPacket._IF_BUTTON10, Client.packetWriter.isaacCipher); // L: 9365
