...
class class17 implements SSLSession {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
		...
		if (var2 == 1) { // L: 8375
			...
			var9 = class120.getPacketBufferNode(ClientPacket._OPLOCU, Client.packetWriter.isaacCipher); // L: 8500
			...
			var9 = class120.getPacketBufferNode(ClientPacket._OPLOCT, Client.packetWriter.isaacCipher); // L: 8774
			...
			var9 = class120.getPacketBufferNode(ClientPacket._OPLOC1, Client.packetWriter.isaacCipher); // L: 8845
			...
			var9 = class120.getPacketBufferNode(ClientPacket._OPLOC2, Client.packetWriter.isaacCipher); // L: 9172
			...
			var9 = class120.getPacketBufferNode(ClientPacket._OPLOC3, Client.packetWriter.isaacCipher); // L: 8413
			...
			var9 = class120.getPacketBufferNode(ClientPacket._OPLOC4, Client.packetWriter.isaacCipher); // L: 9028
			...
			if (var2 == 7) {
				...
				if (var14 != null) { // L: 8880
					...
					var10 = class120.getPacketBufferNode(ClientPacket._OPNPCU, Client.packetWriter.isaacCipher); // L: 8888
				...
				if (var14 != null) { // L: 8821
					...
					var10 = class120.getPacketBufferNode(ClientPacket._OPNPCT, Client.packetWriter.isaacCipher); // L: 8828
				...
				if (var14 != null) { // L: 8864
					...
					var10 = class120.getPacketBufferNode(ClientPacket._OPNPC1, Client.packetWriter.isaacCipher); // L: 8872
				...
				if (var14 != null) { // L: 8721
					...
					var10 = class120.getPacketBufferNode(ClientPacket._OPNPC2, Client.packetWriter.isaacCipher); // L: 8729
				...
				if (var14 != null) { // L: 8705
					...
					var10 = class120.getPacketBufferNode(ClientPacket._OPNPC3, Client.packetWriter.isaacCipher); // L: 8713
				...
				if (var14 != null) { // L: 8422
					...
					var10 = class120.getPacketBufferNode(ClientPacket._OPNPC4, Client.packetWriter.isaacCipher); // L: 8430
				...
				if (var14 != null) { // L: 8674
					...
					var10 = class120.getPacketBufferNode(ClientPacket._OPNPC5, Client.packetWriter.isaacCipher); // L: 8682
				...
				if (var2 == 14) {
					...
					if (var16 != null) { // L: 8631
						...
						var10 = class120.getPacketBufferNode(ClientPacket._OPPLAYERU, Client.packetWriter.isaacCipher); // L: 8639
					...
					if (var16 != null) { // L: 8476
						...
						var10 = class120.getPacketBufferNode(ClientPacket._OPPLAYERT, Client.packetWriter.isaacCipher); // L: 8483
					...
					var9 = class120.getPacketBufferNode(ClientPacket._OPOBJU, Client.packetWriter.isaacCipher); // L: 8558
					...
					var9 = class120.getPacketBufferNode(ClientPacket._OPOBJT, Client.packetWriter.isaacCipher); // L: 8395
					...
					var9 = class120.getPacketBufferNode(ClientPacket._OPOBJ1, Client.packetWriter.isaacCipher); // L: 8606
					...
					var9 = class120.getPacketBufferNode(ClientPacket._OPOBJ2, Client.packetWriter.isaacCipher); // L: 8696
					...
					var9 = class120.getPacketBufferNode(ClientPacket._OPOBJ3, Client.packetWriter.isaacCipher); // L: 9059
					...
					var9 = class120.getPacketBufferNode(ClientPacket._OPOBJ4, Client.packetWriter.isaacCipher); // L: 9013
					...
					var9 = class120.getPacketBufferNode(ClientPacket._OPOBJ5, Client.packetWriter.isaacCipher); // L: 8800
					...
					if (var2 == 24) {
						...
						if (var17 != null) { // L: 8528
							...
							if (var12) { // L: 8531
								var11 = class120.getPacketBufferNode(ClientPacket._BUTTON_CLICK, Client.packetWriter.isaacCipher); // L: 8533
						...
						if (var2 == 26) {
							...
							Widget var15;
							if (var2 == 28) {
								var9 = class120.getPacketBufferNode(ClientPacket._BUTTON_CLICK, Client.packetWriter.isaacCipher); // L: 9143
								...
								var9 = class120.getPacketBufferNode(ClientPacket._BUTTON_CLICK, Client.packetWriter.isaacCipher); // L: 8570
								...
								var9 = class120.getPacketBufferNode(ClientPacket._OPHELDU, Client.packetWriter.isaacCipher); // L: 9079
								...
								var9 = class120.getPacketBufferNode(ClientPacket._OPHELDT, Client.packetWriter.isaacCipher); // L: 8661
								...
								var9 = class120.getPacketBufferNode(ClientPacket._OPHELD1, Client.packetWriter.isaacCipher); // L: 8996
								...
								var9 = class120.getPacketBufferNode(ClientPacket._OPHELD2, Client.packetWriter.isaacCipher); // L: 8541
								...
								var9 = class120.getPacketBufferNode(ClientPacket._OPHELD3, Client.packetWriter.isaacCipher); // L: 9121
								...
								var9 = class120.getPacketBufferNode(ClientPacket._OPHELD4, Client.packetWriter.isaacCipher); // L: 8922
								...
								var9 = class120.getPacketBufferNode(ClientPacket._OPHELD5, Client.packetWriter.isaacCipher); // L: 8965
								...
								if (var2 == 39) {
									var9 = class120.getPacketBufferNode(ClientPacket._IF1_BUTTON1, Client.packetWriter.isaacCipher); // L: 9132
									...
									var9 = class120.getPacketBufferNode(ClientPacket._IF1_BUTTON2, Client.packetWriter.isaacCipher); // L: 9155
									...
									var9 = class120.getPacketBufferNode(ClientPacket._IF1_BUTTON3, Client.packetWriter.isaacCipher); // L: 9068
									...
									var9 = class120.getPacketBufferNode(ClientPacket._IF1_BUTTON4, Client.packetWriter.isaacCipher); // L: 8650
									...
									var9 = class120.getPacketBufferNode(ClientPacket._IF1_BUTTON5, Client.packetWriter.isaacCipher); // L: 8985
									...
									if (var16 != null) { // L: 8584
										...
										var10 = class120.getPacketBufferNode(ClientPacket._OPPLAYER1, Client.packetWriter.isaacCipher); // L: 8592
									...
									if (var16 != null) { // L: 8906
										...
										var10 = class120.getPacketBufferNode(ClientPacket._OPPLAYER2, Client.packetWriter.isaacCipher); // L: 8914
									...
									if (var16 != null) { // L: 8615
										...
										var10 = class120.getPacketBufferNode(ClientPacket._OPPLAYER3, Client.packetWriter.isaacCipher); // L: 8623
									...
									if (var16 != null) { // L: 9037
										...
										var10 = class120.getPacketBufferNode(ClientPacket._OPPLAYER4, Client.packetWriter.isaacCipher); // L: 9045
									...
									if (var16 != null) { // L: 8737
										...
										var10 = class120.getPacketBufferNode(ClientPacket._OPPLAYER5, Client.packetWriter.isaacCipher); // L: 8745
									...
									if (var16 != null) { // L: 8753
										...
										var10 = class120.getPacketBufferNode(ClientPacket._OPPLAYER6, Client.packetWriter.isaacCipher); // L: 8761
									...
									if (var16 != null) { // L: 8512
										...
										var10 = class120.getPacketBufferNode(ClientPacket._OPPLAYER7, Client.packetWriter.isaacCipher); // L: 8520
									...
									if (var16 != null) { // L: 8460
										...
										var10 = class120.getPacketBufferNode(ClientPacket._OPPLAYER8, Client.packetWriter.isaacCipher); // L: 8468
										...
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var17 != null) { // L: 8438
													...
													var10 = class120.getPacketBufferNode(ClientPacket._IF_BUTTONT, Client.packetWriter.isaacCipher); // L: 8448
											...
											if (var2 == 1001) {
												...
												var9 = class120.getPacketBufferNode(ClientPacket._OPLOC5, Client.packetWriter.isaacCipher); // L: 8956
											...
											if (var2 == 1002) {
												...
												var9 = class120.getPacketBufferNode(ClientPacket._OPLOC6, Client.packetWriter.isaacCipher); // L: 8858
											...
											if (var2 == 1003) {
												...
												if (var14 != null) { // L: 8937
													...
													if (var18 != null) { // L: 8940
														var11 = class120.getPacketBufferNode(ClientPacket._IF_BUTTON6, Client.packetWriter.isaacCipher); // L: 8942
											...
											if (var2 == 1004) {
												...
												var9 = class120.getPacketBufferNode(ClientPacket._OPOBJ6, Client.packetWriter.isaacCipher); // L: 8813
											...
											if (var2 == 1005) {
												...
												if (var17 != null && var17.itemQuantities[var0] >= 100000) { // L: 9093
													...
													var10 = class120.getPacketBufferNode(ClientPacket._OPOBJ6_2, Client.packetWriter.isaacCipher); // L: 9096
									...
									case 1:
										if (ItemComposition.method3909(class97.getWidgetFlags(var9))) { // L: 11000
											...
											if (var22 != null) { // L: 11002
												PacketBufferNode var23 = class120.getPacketBufferNode(ClientPacket._UNKNOWN1, Client.packetWriter.isaacCipher); // L: 11003
