	...
	static void method2674(int var0, String var1) {
		...
		for (int var6 = 0; var6 < var2; ++var6) { // L: 9192
			...
			if (var7 != null && var7 != class67.localPlayer && var7.username != null && var7.username.equals(var5)) { // L: 9194
				...
				if (var0 == 1) { // L: 9195
					var8 = class120.getPacketBufferNode(ClientPacket._OPPLAYER1, Client.packetWriter.isaacCipher); // L: 9197
					...
					var8 = class120.getPacketBufferNode(ClientPacket._OPPLAYER4, Client.packetWriter.isaacCipher); // L: 9204
					...
					var8 = class120.getPacketBufferNode(ClientPacket._OPPLAYER6, Client.packetWriter.isaacCipher); // L: 9211
					...
					var8 = class120.getPacketBufferNode(ClientPacket._OPPLAYER7, Client.packetWriter.isaacCipher); // L: 9218
